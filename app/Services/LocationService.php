...
class LocationService
{
    ...
    // Sắp xếp theo thứ tự ưu tiên: Ninh Bình trước
    protected $provinceBoundaries = [
        'Ninh Bình' => [20.15, 20.65, 105.85, 106.05], // ƪu tiên và thu hẹp kinh độ
        'Hà Nội' => [20.8, 21.5, 105.0, 106.0],
        'Hưng Yên' => [20.7, 21.0, 106.0, 106.15], // Thu hẹp để tránh xung đột
        'Hải Dương' => [20.7, 21.2, 106.1, 106.8],
        ...
        'Hà Nam' => [20.35, 20.75, 105.75, 106.15], // Thu hẹp để tránh xung đột
        'Nam Định' => [20.0, 20.5, 105.8, 106.5], // Thu hẹp vĩ độ
