...
use App\Filament\ManagerResources\VipPostApprovalResource\Pages;
use App\Models\Post;
use App\Models\User;
use Filament\Forms;
...
/**
 * Resource để Manager duyệt bài viết của VIP users
 * 
 * Chỉ cho phép:
...
class VipPostApprovalResource extends Resource
{
    ...
    /**
     * Bảng hiển thị bài viết chờ duyệt
     */
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\BulkAction::make('approve_selected')
                        ...
                        ->color('success')
                        ->requiresConfirmation()
                        ->modalHeading('Duyệt bài viết đã chọn')
                        ...
                        ->action(function ($records) {
                            ...
                            return "Đã duyệt {$count} bài viết.";
                        })
                        ->deselectRecordsAfterCompletion(),
                ]),
            ])
            ->defaultSort('created_at', 'desc')
            ->emptyStateHeading('Không có bài viết nào chờ duyệt')
            ->emptyStateDescription('Tất cả bài viết VIP đã được xử lý.');
    }
    ...
    /**
     * Manager không thể tạo bài viết qua resource này
     */
    ...
    /**
     * Manager không thể chỉnh sửa bài viết
     */
    ...
    /**
     * Manager không thể xóa bài viết
     */
    ...
    /**
     * Manager có thể xem tất cả bài viết VIP
     */
