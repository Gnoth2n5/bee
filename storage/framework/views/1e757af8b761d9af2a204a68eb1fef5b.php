    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-6">
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$nearestCity): ?>
                    <!-- Nút lấy vị trí -->
                    ...
                    <div class="mt-4 bg-white bg-opacity-20 rounded-lg p-3 max-w-md mx-auto">
                        <div class="text-center">
                            <div class="flex items-center justify-center mb-2">
                                ...
                                <span class="text-sm font-medium">Thành phố hiện tại: <?php echo e($nearestCity->name); ?></span>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if(session('user_location.is_random')): ?>
            ...
            <!-- Content Section -->
            <div class="p-8">
                <!--[if BLOCK]><![endif]--><?php if(count($recipes) > 0): ?>
                    <!-- Weather Info Card -->
                                ...
                                <div class="mr-4">
                                    ...
                                    <div class="relative">
                                        <select wire:model.live="selectedCity" wire:change="changeCity($event.target.value)" 
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = \App\Models\VietnamCity::active()->ordered()->get()->groupBy('region'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region => $cities): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <optgroup label="<?php echo e($region); ?>">
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($city->code); ?>" <?php echo e($selectedCity === $city->code ? 'selected' : ''); ?>>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($weatherData): ?>
                                        <p class="text-sm text-gray-600 mt-1"><?php echo e($weatherData['weather_description'] ?? 'Thời tiết đẹp'); ?></p>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($weatherData): ?>
                                    <div class="text-center">
                                        <p class="text-3xl font-bold text-blue-500">
                                            <?php echo e(number_format($weatherData['temperature'], 1)); ?>°C
                                        </p>
                                        <p class="text-sm text-gray-600">Nhiệt độ</p>
                                    </div>
                                    <div class="text-center">
                                        <p class="text-3xl font-bold text-blue-500"><?php echo e($weatherData['humidity']); ?>%</p>
                    ...
                    <div class="relative bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                        ...
                        <div class="relative h-96">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="absolute inset-0 transition-opacity duration-500 ease-in-out <?php echo e($index === $currentSlide ? 'opacity-100' : 'opacity-0'); ?>"
                                     id="slide-<?php echo e($index); ?>">
                                    <div class="flex h-full">
                                        ...
                                        <div class="w-1/2 relative">
                                            ...
                                            <div class="absolute top-4 left-4">
                                                <span class="bg-orange-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-lg">
                                                    Món <?php echo e($index + 1); ?>/<?php echo e(count($recipes)); ?>
                                        ...
                                        <div class="w-1/2 p-8 flex flex-col justify-center">
                                            <div class="mb-4">
                                                <h3 class="text-2xl font-bold text-gray-900 mb-2"><?php echo e($recipe->title); ?></h3>
                                                <p class="text-gray-600 line-clamp-3"><?php echo e($recipe->summary); ?></p>
                                            </div>
                                            ...
                                            <div class="flex items-center space-x-4 mb-4 text-sm text-gray-500">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <?php echo e(number_format($recipe->average_rating, 1)); ?>
                        ...
                        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button wire:click="goToSlide(<?php echo e($index); ?>)" 
                                        class="w-3 h-3 rounded-full transition-all duration-200 <?php echo e($index === $currentSlide ? 'bg-orange-500' : 'bg-gray-300 hover:bg-gray-400'); ?>">
                                </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-8">
                        <a href="<?php echo e(route('weather.suggestions')); ?>" 
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        (position) => {
                            ...
                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').setUserLocation(latitude, longitude);
                        },
                        (error) => {
                            ...
                            if (error.code === 1) { // PERMISSION_DENIED
                                ...
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').randomCity();
                            } else {
                                Swal.fire({
                                    title: 'Lỗi',
        ...
        if (savedLocation) {
            try {
                ...
                if (now - locationData.timestamp < oneHour) {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').setUserLocation(locationData.latitude, locationData.longitude);
                } else {
...
</div> <?php /**PATH D:\DuAn1\test\bee\resources\views/livewire/weather-slideshow-simple.blade.php ENDPATH**/ ?>