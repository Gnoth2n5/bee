            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="relative bg-white rounded-lg shadow-lg overflow-hidden">
                        <!--[if BLOCK]><![endif]--><?php if($popularPosts->count() > 0): ?>
                            <!-- Slide container -->
                            <div class="relative h-96">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $popularPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="absolute inset-0 transition-opacity duration-500 <?php echo e($index === $currentSlide ? 'opacity-100' : 'opacity-0'); ?>">
                                        <div class="relative h-full">
                                            ...
                                            <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                                                <div class="flex items-center text-sm text-orange-200 mb-2">
                                                    ...
                                                    <?php echo e($post->published_at ? $post->published_at->diffForHumans() : 'Chưa xuất bản'); ?>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center text-sm text-orange-200">
                                                        ...
                                                        <?php echo e(number_format($post->view_count)); ?> lượt xem
                                                    </div>
                            ...
                            <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $popularPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button wire:click="goToSlide(<?php echo e($index); ?>)" 
                                            class="w-3 h-3 rounded-full transition-colors duration-200 <?php echo e($index === $currentSlide ? 'bg-white' : 'bg-white/50'); ?>">
                                    </button>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        <?php else: ?>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div class="space-y-4">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $latestPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <article class="group">
                                        ...
                                        <div class="flex space-x-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="flex items-center text-xs text-gray-500 mt-2">
                                                    ...
                                                    <span><?php echo e($post->published_at ? $post->published_at->diffForHumans() : 'Chưa xuất bản'); ?></span>
                                                </div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($latestPosts->count() > 0): ?>
...
</div> <?php /**PATH D:\DuAn1\test\bee\resources\views/livewire/posts/post-section.blade.php ENDPATH**/ ?>