<div class="relative">
    ...
    <!--[if BLOCK]><![endif]--><?php if($showSuggestions): ?>
    <div 
    ...
    >
        <!--[if BLOCK]><![endif]--><?php if(!empty($searchQuery) && $suggestions['recipes']->count() > 0): ?>
            <!-- Search Results -->
            <div class="p-4">
                <div class="space-y-2">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $suggestions['recipes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a 
                            href="<?php echo e(route('recipes.show', $recipe)); ?>"
                            class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors"
                            wire:click="showSuggestions = false"
                        >
                            <!--[if BLOCK]><![endif]--><?php if($recipe->featured_image): ?>
                                <img 
                                    src="<?php echo e(Storage::url($recipe->featured_image)); ?>" 
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center space-x-2 text-xs text-gray-500">
                                    <span><?php echo e($recipe->cooking_time); ?> phút</span>
                                    <span>•</span>
                                    <span><?php echo e(ucfirst($recipe->difficulty)); ?></span>
                                    <!--[if BLOCK]><![endif]--><?php if($recipe->average_rating > 0): ?>
                                        <span>•</span>
                                        <div class="flex items-center space-x-1">
                                            <svg class="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                            </svg>
                                            <span><?php echo e(number_format($recipe->average_rating, 1)); ?></span>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </div>
                ...
                <!--[if BLOCK]><![endif]--><?php if($suggestions['recipes']->count() >= 8): ?>
                <div class="border-t border-gray-200 p-3">
                    <a 
                        href="<?php echo e(route('recipes.index', ['search' => $searchQuery])); ?>"
        ...
        <?php elseif(!empty($searchQuery) && $suggestions['recipes']->count() == 0): ?>
            <!-- No Results -->
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH D:\DuAn1\test\bee\resources\views/livewire/quick-search.blade.php ENDPATH**/ ?>