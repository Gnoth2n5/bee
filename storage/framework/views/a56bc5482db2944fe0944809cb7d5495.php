            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Lập kế hoạch bữa ăn cho cả tuần và xem tổng quan món ăn theo tuần</p>
                        </div>
                        ...
                        <div class="flex space-x-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($currentMealPlan): ?>
                                <a href="<?php echo e(route('meal-plans.export', $currentMealPlan)); ?>" 
                    ...
                    <!-- Statistics -->
                    <!--[if BLOCK]><![endif]--><?php if($currentMealPlan && !empty($statistics)): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($currentMealPlan): ?>
                            ...
                            <table class="w-full border-collapse border border-gray-300">
                                <thead>
                                    <tr class="bg-gray-50">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $mealTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <th class="border border-gray-300 px-4 py-2 text-center"><?php echo e($label); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $mealTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <td class="border border-gray-300 px-4 py-2 min-h-[100px]">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($meals)): ?>
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $meals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipeId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                                $recipe = Recipe::find($recipeId);
                                                            ?>
                                                            <!--[if BLOCK]><![endif]--><?php if($recipe): ?>
                                                                <div class="flex items-center justify-between p-2 bg-orange-50 rounded mb-2">
                                                                    <div class="flex-1">
                                                                        <div class="font-medium text-sm"><?php echo e($recipe->title); ?></div>
                                                                        <!--[if BLOCK]><![endif]--><?php if($recipe->calories_per_serving): ?>
                                                                            <div class="text-xs text-gray-500"><?php echo e($recipe->calories_per_serving); ?> cal</div>
                                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                                    </div>
                                                                    <button wire:click="removeMeal('<?php echo e($dayKey); ?>', '<?php echo e($type); ?>', <?php echo e($recipeId); ?>)" 
                                                    ...
                                                    <!-- Add meal button -->
                                                    <button onclick="openAddMealModal('<?php echo e($dayKey); ?>', '<?php echo e($type); ?>')" 
                        ...
                        <div class="flex justify-between items-center mt-6">
                            ...
                            <div class="text-sm text-gray-500">
                                Tuần từ <?php echo e(Carbon::parse($selectedWeek)->format('d/m/Y')); ?> 
                                đến <?php echo e(Carbon::parse($selectedWeek)->addDays(6)->format('d/m/Y')); ?>
...
function loadRecipes() {
    ...
    fetch(`/api/recipes/search?q=${encodeURIComponent(searchQuery)}`)
        ...
        .then(data => {
            ...
            if (data.data && data.data.length > 0) {
                data.data.forEach(recipe => {
                    ...
                    recipeDiv.className = 'flex items-center justify-between p-3 border-b hover:bg-gray-50';
                    recipeDiv.innerHTML = `
                        <div>
        ...
        .catch(error => {
            ...
            document.getElementById('recipeResults').innerHTML = '<p class="text-red-500 p-3">Có lỗi khi tải công thức</p>';
        });
}

function addRecipeToMealPlan(recipeId) {
    window.Livewire.find('<?php echo e($_instance->getId()); ?>').addMeal(currentDay, currentMealType, recipeId);
    closeAddMealModal();
}
...
<?php /**PATH D:\DuAn1\test\bee\resources\views/livewire/meal-plans/weekly-meal-plan-page.blade.php ENDPATH**/ ?>