            ...
            <div class="p-6 text-gray-900">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" 
                                 ...
                                 <div class="py-1">
                                     <a href="<?php echo e(route('meal-plans.export-all')); ?>" 
                                     ...
                                     <a href="<?php echo e(route('meal-plans.export-all-csv')); ?>" 
                                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                     ...
                                     <a href="<?php echo e(route('meal-plans.export-all-pdf')); ?>" 
                                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                     ...
                                     <a href="<?php echo e(route('meal-plans.export-all-zip')); ?>" 
                                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                     ...
                                     <a href="<?php echo e(route('meal-plans.export-all-xml')); ?>" 
                                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                     ...
                                     <a href="<?php echo e(route('meal-plans.export-all-markdown')); ?>" 
                                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                     ...
                                     <a href="<?php echo e(route('meal-plans.export-all-json')); ?>" 
                                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <div class="text-2xl font-bold text-blue-600"><?php echo e($mealPlans->total()); ?></div>
                        <div class="text-sm text-blue-600">Tổng kế hoạch</div>
                    </div>
                    <div class="bg-green-50 p-4 rounded-lg">
                        <div class="text-2xl font-bold text-green-600"><?php echo e($mealPlans->where('is_active', true)->count()); ?></div>
                        <div class="text-sm text-green-600">Đang hoạt động</div>
                    </div>
                    <div class="bg-yellow-50 p-4 rounded-lg">
                        <div class="text-2xl font-bold text-yellow-600"><?php echo e($mealPlans->where('weather_optimized', true)->count()); ?></div>
                        <div class="text-sm text-yellow-600">Tối ưu thời tiết</div>
                    </div>
                    <div class="bg-purple-50 p-4 rounded-lg">
                        <div class="text-2xl font-bold text-purple-600"><?php echo e($mealPlans->where('ai_suggestions_used', true)->count()); ?></div>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                                <div class="p-4">
                                    ...
                                    <div class="text-sm text-gray-600 mb-3">
                                        <div>Tuần từ: <?php echo e($mealPlan->week_start->format('d/m/Y')); ?></div>
                                        <div>Đến: <?php echo e($mealPlan->week_start->addDays(6)->format('d/m/Y')); ?></div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2 mb-3">
                                        <div class="text-center p-2 bg-blue-50 rounded">
                                            <div class="text-sm font-medium text-blue-600"><?php echo e($statistics['total_meals']); ?></div>
                                            <div class="text-xs text-blue-500">Bữa ăn</div>
                                        </div>
                                        <div class="text-center p-2 bg-green-50 rounded">
                                            <div class="text-sm font-medium text-green-600"><?php echo e($statistics['completion_percentage']); ?>%</div>
                                            <div class="text-xs text-green-500">Hoàn thành</div>
                                        </div>
                                    </div>
                                    
                                    <div class="text-xs text-gray-500 mb-3">
                                        <div>Tạo lúc: <?php echo e($mealPlan->created_at->format('d/m/Y H:i')); ?></div>
                                        <?php if($mealPlan->total_calories > 0): ?>
                                            <div>Calories: <?php echo e(number_format($mealPlan->total_calories)); ?> cal</div>
                                        <?php endif; ?>
                                        <?php if($mealPlan->total_cost > 0): ?>
                                            <div>Chi phí: <?php echo e(number_format($mealPlan->total_cost)); ?>đ</div>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DuAn1\test\bee\resources\views/meal-plans/index.blade.php ENDPATH**/ ?>