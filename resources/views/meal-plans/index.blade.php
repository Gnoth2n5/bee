                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <a href="{{ route('meal-plans.export-all-xml') }}"
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            <svg class="w-4 h-4 mr-3 text-orange-600" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            </svg>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-green-50 p-4 rounded-lg">
                            <div class="text-2xl font-bold text-green-600">
                                {{ $mealPlans->where('is_active', true)->count() }}</div>
                            <div class="text-sm text-green-600">Đang hoạt động</div>
                        </div>
                        <div class="bg-yellow-50 p-4 rounded-lg">
                            <div class="text-2xl font-bold text-yellow-600">
                                {{ $mealPlans->where('weather_optimized', true)->count() }}</div>
                            <div class="text-sm text-yellow-600">Tối ưu thời tiết</div>
                        </div>
                        <div class="bg-purple-50 p-4 rounded-lg">
                            <div class="text-2xl font-bold text-purple-600">
                                {{ $mealPlans->where('ai_suggestions_used', true)->count() }}</div>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-2 mb-3">
                                            <div class="text-center p-2 bg-blue-50 rounded">
                                                <div class="text-sm font-medium text-blue-600">
                                                    {{ $statistics['total_meals'] }}</div>
                                                <div class="text-xs text-blue-500">Bữa ăn</div>
                                            </div>
                                            <div class="text-center p-2 bg-green-50 rounded">
                                                <div class="text-sm font-medium text-green-600">
                                                    {{ $statistics['completion_percentage'] }}%</div>
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="{{ route('meal-plans.show', $mealPlan) }}"
                                                class="flex-1 bg-orange-600 hover:bg-orange-700 text-white text-center px-3 py-2 rounded-lg text-sm transition-colors flex items-center justify-center gap-2">
                                            ...
                                            <div class="relative inline-block" x-data="{ open: false }">
                                                <button @click="open = !open"
                                                    class="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg text-sm transition-colors flex items-center justify-center"
                                                    title="Xuất dữ liệu">
                                                ...
                                                <div x-show="open" @click.away="open = false"
                                                    ...
                                                    <div class="py-1">
                                                        <a href="{{ route('meal-plans.export', $mealPlan) }}"
                                                            ...
                                                            <svg class="w-3 h-3 mr-2 text-green-600" fill="none"
                                                        ...
                                                        <a href="{{ route('meal-plans.export-csv', $mealPlan) }}"
                                                            class="flex items-center px-3 py-2 text-xs text-gray-700 hover:bg-gray-100">
                                                            <svg class="w-3 h-3 mr-2 text-blue-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                        ...
                                                        <a href="{{ route('meal-plans.export-pdf', $mealPlan) }}"
                                                            class="flex items-center px-3 py-2 text-xs text-gray-700 hover:bg-gray-100">
                                                            <svg class="w-3 h-3 mr-2 text-red-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                                        ...
                                                        <a href="{{ route('meal-plans.export-zip', $mealPlan) }}"
                                                            class="flex items-center px-3 py-2 text-xs text-gray-700 hover:bg-gray-100">
                                                            <svg class="w-3 h-3 mr-2 text-purple-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                                        ...
                                                        <a href="{{ route('meal-plans.export-xml', $mealPlan) }}"
                                                            class="flex items-center px-3 py-2 text-xs text-gray-700 hover:bg-gray-100">
                                                            <svg class="w-3 h-3 mr-2 text-orange-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                        ...
                                                        <a href="{{ route('meal-plans.export-markdown', $mealPlan) }}"
                                                            class="flex items-center px-3 py-2 text-xs text-gray-700 hover:bg-gray-100">
                                                            <svg class="w-3 h-3 mr-2 text-indigo-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                        ...
                                                        <a href="{{ route('meal-plans.export-json', $mealPlan) }}"
                                                            class="flex items-center px-3 py-2 text-xs text-gray-700 hover:bg-gray-100">
                                                            <svg class="w-3 h-3 mr-2 text-teal-600" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            ...
                                            <a href="{{ route('meal-plans.edit', $mealPlan) }}"
                                                class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-sm transition-colors flex items-center justify-center">
                                            ...
                                            <form action="{{ route('meal-plans.destroy', $mealPlan) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-lg text-sm transition-colors flex items-center justify-center">
