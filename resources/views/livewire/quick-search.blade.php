<div class="relative" x-data @click.away="$wire.showSuggestions = false">
    <!-- Search Input -->
    <div class="relative">
        <input
            type="text"
            ...
            class="w-full pl-12 pr-10 py-4 text-gray-900 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-lg shadow-lg"
             ...
             <div class="p-4">
                 <div class="space-y-2">
                          ...
                          <a 
                              ...
                              wire:click="$wire.showSuggestions = false"
                          >
