    ...
    <div class="flex flex-wrap justify-between items-center max-w-7xl mx-auto">
        ...
        <div class="flex items-center space-x-4">
            ...
            <button onclick="toggleTheme()" 
                    class="p-2 text-gray-500 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 rounded-xl transition-all duration-300 hover:bg-gray-100 dark:hover:bg-gray-800">
