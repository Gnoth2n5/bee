...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        <x-nav-link :href="route('recipes.my')" :active="request()->routeIs('recipes.my')" wire:navigate>
                            {{ __('Công thức của tôi') }}
                        </x-nav-link>
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <!-- Authentication -->
                            <form wire:submit="logout" id="logout-form">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                <x-responsive-nav-link :href="route('recipes.my')" :active="request()->routeIs('recipes.my')" wire:navigate>
                    {{ __('Công thức của tôi') }}
                </x-responsive-nav-link>
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <!-- Authentication -->
                    <form wire:submit="logout" id="logout-form-mobile">
