                                        ...
                                        <tr>
                                            ...
                                            @foreach($mealTypes as $type => $label)
                                                <td class="border border-gray-300 px-4 py-2 min-h-[100px]">
                                                                ...
                                                                <div class="flex items-center justify-between p-2 bg-orange-50 rounded mb-2">
                                                                    <div class="flex-1">
                                                                        ...
                                                                        @if($recipe->calories_per_serving)
                                                                            <div class="text-xs text-gray-500">{{ $recipe->calories_per_serving }} cal</div>
                                                                        @endif
                                                                    </div>
                                                                    <button wire:click="removeMeal('{{ $dayKey }}', '{{ $type }}', {{ $recipeId }})" 
                                                    ...
                                                    <!-- Add meal button -->
                                                    <button onclick="openAddMealModal('{{ $dayKey }}', '{{ $type }}')" 
